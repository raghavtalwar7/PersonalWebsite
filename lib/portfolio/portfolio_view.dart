...
class _PortfolioViewState extends State<PortfolioView> with AfterLayoutMixin {
  ...
  void afterFirstLayout(BuildContext context) {
    setState(() {
      navigationItems = [
        NavigationItem('Projects', FontAwesomeIcons.projectDiagram,
            key: projectKey),
        NavigationItem('Skills', FontAwesomeIcons.tasks, key: skillsKey),
        NavigationItem('Experiences', FontAwesomeIcons.graduationCap,
            key: experienceKey),
        // NavigationItem('Blog', FontAwesomeIcons.blog, key: blogKey),
      ];
    });
  }
